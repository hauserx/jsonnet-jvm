...
public class JsonnetLogicalOrNode extends JsonnetExpressionNode {
  @Child private JsonnetExpressionNode leftNode;
  @Child private JsonnetExpressionNode rightNode;

  public JsonnetLogicalOrNode(JsonnetExpressionNode leftNode, JsonnetExpressionNode rightNode) {
