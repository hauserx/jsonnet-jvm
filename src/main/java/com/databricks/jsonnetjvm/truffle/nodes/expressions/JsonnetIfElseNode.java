...
public class JsonnetIfElseNode extends JsonnetExpressionNode {
  ...
  @Child private JsonnetExpressionNode thenExpr;
  @Child private JsonnetExpressionNode elseExpr;

  public JsonnetIfElseNode(
      JsonnetExpressionNode condition,
      JsonnetExpressionNode thenExpr,
